...
function CategoryCard({ category: { name, description }, onClick }) {
  return (
    <div
      className="flex-1 sm:w-[350px] bg-slate-50 sm:min-w-[350px] w-full rounded-[20px] shadow-3xl px-10 py-16 shadow-lg cursor-pointer hover:-translate-y-2 transition-transform duration-200"
      onClick={onClick}
    >
